...
export class MultipleKnapsacks extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            instructionsData: [['15', '23'], ['33', '45'], ['313', '145'], ['233', '345'], ['433', '545'], ['313', '435'], ['bins', '{100,100,50,300}']]
        };
            ...
            <Fragment>
                <Container fixed>
                    <Grid container spacing={2} className={styles.gridPadding}>
                        <Grid item xs={12}>
                            <CustomBreadCrumb links={[{"title": "Home", "url": "/"}, {"title": "OR Tools", "url": "/select/algorithm"}, {"title": "Multiple Knapsacks", "url": ""}]} title="Multiple Knapsacks" />
