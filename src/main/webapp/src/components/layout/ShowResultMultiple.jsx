                    ...
                    <Grid item xs={12} md={12} lg={6} xl={6} component={Paper}>
                        ...
                        <Container>
                            <Grid container spacing={3}>
                                <Grid item xs={6}>
                                    <CSVLink uFEFF={false} headers={this.state.headers} filename={"multiple-knapsacks-initial-" + this.props.match.params.id + ".csv"} data={this.state.initialData} separator={";"}>
                                ...
                                <Grid item xs={6}>
                                    <CSVLink filename={"multiple-knapsacks-result-" + this.props.match.params.id + ".csv"} data={this.state.results} separator={";"}>
